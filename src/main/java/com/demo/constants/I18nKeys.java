...
public class I18nKeys {
    ...
    public static final String accountRegesitSuccess = "accountRegesitSuccess";
    public static final String accountRegesitFailure = "accountRegesitFailure";
    public static final String manMachineCheckFailure = "manMachineCheckFailure";
    ...
    public static final String pwdResetSuccess = "pwdResetSuccess";
}
